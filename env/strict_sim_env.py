...
class StrictOptionSimEnv(gym.Env):
    """
    High-Performance Gymnasium Environment for Intraday Options Research.
    Optimized with C-contiguous NumPy arrays for fast step execution.
    """
    ...
    def __init__(self, df: pd.DataFrame, feature_cols: list, initial_capital: float = 100000.0, sequence_length: int = 60):
        ...
        # NumPy arrays to prevent Pandas DataFrame slicing overhead during environment steps
        ...
        self.LOT_SIZE = 25
        self.STT_PREMIUM_RATE = 0.000625
    ...
    def step(self, action: np.ndarray) -> tuple[np.ndarray, float, bool, bool, dict]:
        ...
        truncated = self.capital <= (self.initial_capital * 0.70)
